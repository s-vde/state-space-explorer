...
int main()
{
   ...
   dpor_number_of_executions_test("shared_memory_access_non_concurrent.cpp", "-std=c++14", 1);
   /// @cite Flanagan:2005:DPR:1040305.1040315 page 8
   dpor_number_of_executions_test("../../libs/record-replay/tests/test_programs/real_world/filesystem.c", "-DNR_THREADS=13", 1);
   /// @cite Abdulla:2014:ODP:2535838.2535845
   dpor_number_of_executions_test("benchmarks/readers_nonpreemptive.c", "", 5);
